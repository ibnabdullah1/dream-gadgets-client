            ...
            <div>
              ...
              <div className="  flex gap-4 mt-6">
                <button
                  ...
                  className="l bg-[#ffc107] dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700"
                >
                  Add to Cart
                </button>
                <Link to={"/hp"}>
...
export default HpProductDetails;
